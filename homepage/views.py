...
VIEW_ERRORS = {
    404: {
        "title": _("404 - Page non trouvée"),
        "content": _(
            """A 404 la page demandée est indisponible ou
             le serveur n'arrive pas à la trouver."""
        ),
    },
    500: {
        "title": _("500 Serveur Erreure"),
        "content": _(
            """A 500  le serveur est temporairement indisponible
            ou en maintenance"""
        ),
    },
    403: {
        "title": _("Permission refusée"),
